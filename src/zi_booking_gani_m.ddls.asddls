...
@EndUserText.label: 'booking inerface view managed'
@Metadata.ignorePropagatedAnnotations: true
define view entity zi_booking_gani_m
  as select from zbooking_gani_m
  composition [0..*] of zi_booksuppl_gani_m as _BookingSuppl
  association        to parent zi_travel_gani_m  as _Travel         on  $projection.TravelId = _Travel.TravelId
